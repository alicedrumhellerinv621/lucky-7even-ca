...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-2854aa7d');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-2854aa7d');}
...
var brandEl=document.querySelector('.rl-brand-2854aa7d');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
